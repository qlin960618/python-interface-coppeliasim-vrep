...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        cmake_args = ['-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=' + extdir,
                      ...
                      '-DCMAKE_POLICY_VERSION_MINIMUM=3.5']  # for the outdated vrep submodule
...
setup(
    ext_modules=[CMakeExtension('dqrobotics.interfaces.vrep._core')],
    cmdclass=dict(build_ext=CMakeBuild),
    zip_safe=False,
    packages=['dqrobotics.interfaces.vrep'],
    classifiers=[
